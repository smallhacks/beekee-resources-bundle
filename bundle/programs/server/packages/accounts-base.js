...
class AccountsServer extends AccountsCommon {
  ...
  _hashStampedToken(stampedToken) {
    const hashedStampedToken = Object.keys(stampedToken).reduce((prev, key) => key === 'token' ? prev : _objectSpread({}, prev, {
